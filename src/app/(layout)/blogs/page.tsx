  ...
  return <div className="md:flex md:p-10">
    <div className="w-3/5 min-w-60 sticky top-32 left-0 self-start hidden md:block">
      <div className="flex flex-col justify-center">
        ...
        {/* <p className="mt-5 mb-5 text-center">Interest is the best teacher, keep your passion for learning</p> */}
      </div>
      <ul>
        {typeData.map((item, i) => (
          <li key={i} className="flex justify-center pt-5 pb-5 pl-10 pr-10 cursor-pointer hover:shadow-[0_0_10px_#2e2e2e]">
            {item.icon("text-2xl")}
